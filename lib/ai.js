...
// callers handle a null return, so if the API errors, is slow, or the
// key is missing, nothing breaks.
//
...
async function claude(opts) {
  ...
  // Abort if it takes too long — an endpoint should never hang on AI
...
module.exports = { claude, DEFAULT_MODEL };
